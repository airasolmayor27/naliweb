...
class User_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.name, BaseTbl.mobile,BaseTbl.assign, BaseTbl.isAdmin, BaseTbl.createdDtm, 
    ...
    function addNewUser($userInfo)
    {
        ...
        // Insert information data into 'tbl_information' with the associated user_id
...
/**
 * This function is used to update user information in the system
 * @param array $userInfo: An associative array of user information to update
 ...
 */
    ...
    function editUserInformation($userInfo, $userId)
    {
        $this->db->set($userInfo); // Set the values from the $userInfo array
