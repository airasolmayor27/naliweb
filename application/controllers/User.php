...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'NALI : Dashboard';
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'NaLi : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Nali : Add New User';
        ...
        else
        {
            ...
            else
            {
                ...
                $userInfo = array('email'=>$email, 'password'=>getHashedPassword($password), 'roleId'=>$roleId,
                        'name'=> $name, 'mobile'=>$mobile,'assign'=>$assign, 'isAdmin'=>$isAdmin,
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Nali : Edit User';
    ...
    function editUser()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if(empty($password))
                {
                    $userInfo = array('email'=>$email, 'roleId'=>$roleId, 'name'=>$name, 'mobile'=>$mobile,'assign'=>$assign,
                        'isAdmin'=>$isAdmin, 'updatedBy'=>$this->vendorId, 'updatedDtm'=>date('Y-m-d H:i:s'));
                }
                else
                {
                    $userInfo = array('email'=>$email, 'password'=>getHashedPassword($password), 'roleId'=>$roleId,
                        'name'=>ucwords($name), 'mobile'=>$mobile,'assign'=>$assign, 'isAdmin'=>$isAdmin, 
    ...
    {
        $this->global['pageTitle'] = 'NIPA : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'NIPA : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'NIPA : My Profile' : 'NIPA : Change Password';
